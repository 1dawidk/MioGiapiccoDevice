...
#define DHT11_DATA1_IN					GPIOA->CRH= (GPIOA->CRH&(~(0xF<<P10s*4))) | (8<<P10s*4)
#define DHT11_DATA1_OUT					GPIOA->CRH=(GPIOA->CRH&(~(0xF<<P10s*4))) | (3<<P10s*4)
#define DHT11_DATA1_H					SET_SEG(DH11_SEG) |= DH11_DATA1_PIN
#define DHT11_DATA1_L					SET_SEG(DH11_SEG) &= ~DH11_DATA1_PIN
#define DHT11_DATA1_READ				(READ_SEG(DH11_SEG)&DH11_DATA1_PIN)

#define DHT11_DATA2_IN					GPIOA->CRH= (GPIOA->CRH&(~(0xF<<P9s*4))) | (4<<P9s*4)
#define DHT11_DATA2_OUT					GPIOA->CRH=(GPIOA->CRH&(~(0xF<<P9s*4))) | (3<<P9s*4)
#define DHT11_DATA2_H					SET_SEG(DH11_SEG) |= DH11_DATA2_PIN
#define DHT11_DATA2_L					SET_SEG(DH11_SEG) &= ~DH11_DATA2_PIN
#define DHT11_DATA2_READ				(READ_SEG(DH11_SEG)&DH11_DATA2_PIN)

#define DHT11_DATA3_IN					GPIOA->CRH= (GPIOA->CRH&(~(0xF<<P8s*4))) | (4<<P8s*4)
#define DHT11_DATA3_OUT					GPIOA->CRH=(GPIOA->CRH&(~(0xF<<P8s*4))) | (3<<P8s*4)
#define DHT11_DATA3_H					SET_SEG(DH11_SEG) |= DH11_DATA3_PIN
#define DHT11_DATA3_L					SET_SEG(DH11_SEG) &= ~DH11_DATA3_PIN
#define DHT11_DATA3_READ				(READ_SEG(DH11_SEG)&DH11_DATA3_PIN)
//*******************************************
